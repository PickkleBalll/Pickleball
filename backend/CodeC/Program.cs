...
builder.Services.AddSwaggerGen(options =>
{
    ...
    // ✅ Thêm phần này để đọc file XML summary
...
builder.Services.AddScoped<VideoFeedbackService>();
builder.Services.AddScoped<GetLearnersByCoachId>();
builder.Services.AddScoped<GetAllLearnerInfos>();
builder.Services.AddScoped<CoachFeedbackService>();
builder.Services.AddScoped<CoachRequestService>();
