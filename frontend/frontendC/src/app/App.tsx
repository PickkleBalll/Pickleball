...
import EditCoachProfile from '@/pages/EditProfileCoach';
import AdminDashboard from '@/components/Dashboard/Admin/AdminDashboard';
import CourseManagement from '../pages/admin-pages/content-management';
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="/editProfile" element={<EditLearnerProfile />} />
      </Route>
      ...
      >
        <Route path="/admin">
          ...
          <Route path="content-management" element={<CourseManagement />} />
      ...
      >
        <Route path="/coach">
          ...
          <Route path="edit-profile" element={<EditCoachProfile />} />
        </Route>
      </Route>
    </Routes>
  );
