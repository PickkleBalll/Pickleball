...
const Hero: React.FC = () => {
  ...
  return (
    <section
      id="home"
      className="flex justify-center scroll-mt-28 pt-25"
    >
      <div className="relative w-[1440px] h-[800px] bg-[#212121] rounded-[50px] px-[60px] pt-[40px] pb-[40px] text-white font-['Roboto'] overflow-hidden mx-auto">
        ...
        <div className="absolute top-[363px] left-[60px] w-[542px] text-[24px] text-justify leading-[1.5]">
          Connect with top pickleball coaches anytime, anywhere. Our AI-powered app analyzes your
          gameplay, gives real-time feedback, and creates personalized training plans. Upload
          videos, track your progress, and improve faster with smart insights — all in one seamless
          platform.
        </div>
